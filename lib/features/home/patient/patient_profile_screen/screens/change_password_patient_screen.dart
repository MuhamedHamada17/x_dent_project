...
class ChangePasswordPatientScreen extends StatefulWidget {
  const ChangePasswordPatientScreen({super.key});

  @override
  State<ChangePasswordPatientScreen> createState() => _ChangePasswordScreenState();
}

class _ChangePasswordScreenState extends State<ChangePasswordPatientScreen> {
  @override
