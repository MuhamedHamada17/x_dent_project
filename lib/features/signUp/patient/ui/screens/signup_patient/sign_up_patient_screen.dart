...
import 'package:x_dent_project/features/signUp/patient/ui/widgets/sign_patient_bloc_listner.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text("الاسم الأول", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("الاسم الأخير", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("البريد الإلكتروني", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("رقم الهاتف", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("كلمة المرور", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text("تأكيد كلمة المرور", style: TextStyles.font14BlackSemiBold),
                      ],
                    ),
                    verticalSpace(8),
                    SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Text("تسجيل الدخول", style: TextStyles.font14BlueRegular),
                        ),
                      ],
                    ),
                  ],
